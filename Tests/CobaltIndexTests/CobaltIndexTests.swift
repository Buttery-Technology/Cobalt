...
@Test func testBTreeInsertAndSearch() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_test_\(UUID().uuidString).db"
...
@Test func testBTreeRangeQuery() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_range_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testBTreeDelete() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_del_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testColumnIndex() async throws {
    let path = NSTemporaryDirectory() + "cobalt_colidx_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testBTreeDuplicateKeys() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_dup_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testBTreeDeleteAllThenReinsert() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_empty_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testBTreeLargeDatasetWithSplits() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_large_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testBTreeStringKeys() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_str_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testBTreeDeleteFromMiddle() async throws {
    let path = NSTemporaryDirectory() + "cobalt_btree_delmid_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testIndexManagerMultipleColumns() async throws {
    let path = NSTemporaryDirectory() + "cobalt_im_multi_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testIndexManagerNullLookup() async throws {
    let path = NSTemporaryDirectory() + "cobalt_im_null_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testIndexManagerRemoveIndexes() async throws {
    let path = NSTemporaryDirectory() + "cobalt_im_remove_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
...
@Test func testColumnIndexRangeQuery() async throws {
    let path = NSTemporaryDirectory() + "cobalt_colidx_range_\(UUID().uuidString).db"
    defer { try? FileManager.default.removeItem(atPath: path) }
