...
/// A type-safe query builder for CobaltModel types.
/// Supports filter, sort, limit, and terminal operations (all, first, count, delete).
public struct ModelQuery<M: CobaltModel>: Sendable {
    internal let database: CobaltDatabase
...
// MARK: - CobaltDatabase Model Extensions
...
extension CobaltDatabase {
    ...
    public func save<M: CobaltModel>(_ model: M) async throws {
    ...
    public func find<M: CobaltModel>(_ type: M.Type, id: String) async throws -> M? {
    ...
    public func findAll<M: CobaltModel>(_ type: M.Type) async throws -> [M] {
    ...
    @discardableResult
    public func delete<M: CobaltModel>(_ model: M) async throws -> Int {
    ...
    public func saveAll<M: CobaltModel>(_ models: [M]) async throws {
    ...
    public func query<M: CobaltModel>(_ type: M.Type) -> ModelQuery<M> {
