...
// MARK: - CobaltModel Protocol

/// A type-safe model that can be stored in a Cobalt database.
...
/// }
///
/// struct HTTPLog: CobaltModel {
///     static let tableName = "http_logs"  // Custom override
///     var id: String = UUID().uuidString
///     var url: String
/// }
/// ```
public protocol CobaltModel: Codable, Sendable {
...
public struct Column<M: CobaltModel, V: DBValueConvertible>: Sendable {
...
public struct ModelFilter<M: CobaltModel>: Sendable {
