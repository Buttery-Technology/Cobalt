...
public protocol DBValueConvertible: Sendable {
    ...
    static var columnType: CobaltColumnType { get }
...
extension Int: DBValueConvertible {
    public static var columnType: CobaltColumnType { .integer }
...
extension Double: DBValueConvertible {
    public static var columnType: CobaltColumnType { .double }
...
extension Bool: DBValueConvertible {
    public static var columnType: CobaltColumnType { .boolean }
...
extension Data: DBValueConvertible {
    public static var columnType: CobaltColumnType { .blob }
...
extension Optional: DBValueConvertible where Wrapped: DBValueConvertible {
    public static var columnType: CobaltColumnType { Wrapped.columnType }
